    ...
    <section className="sticky top-0 z-0 min-h-screen overflow-hidden bg-rich-black">
      ...
      {hasVideos && (
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <div className="absolute inset-x-0 bottom-0 h-[50%] bg-gradient-to-t from-black/70 to-transparent z-[1]" />
      ...
      <div className="relative z-20 max-w-[1100px] mx-auto w-full flex flex-col items-center text-center">
        ...
        <FadeIn variant="blur-up" delay={0.55} duration={1}>
          <p className="font-body text-body-lg text-white mb-9 max-w-[540px]">
